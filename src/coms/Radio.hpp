...
float radio_indi(void);         /* raw attitude-ctrl switch position [-1, 1], channel 7 (3-pos) */
bool  radio_use_jerk(void);     /* PID/PIDJ attitude ctrl switch, channel 7 (3-pos; PIDJ = 3rd/highest position only, else PID) */
