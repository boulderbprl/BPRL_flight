...
namespace InputIdx {
    ...
    constexpr int INDI_STK    = 5; // attitude ctrl switch [-1,1] (channel 7, raw); >0.33=PIDJ, else PID (see radio_use_jerk()). AttitudeINDI is always shadow-run, never selected by this switch.
