...
AttitudePID::AttitudePID()
    ...
    , _roll_rate (0.09f, 0.075f, 0.001f, 0.5f, 0.0f, 0.0f, 30.0f)
    , _pitch_rate(0.13f, 0.100f, 0.002f, 0.5f, 0.0f, 0.0f, 30.0f)
    , _yaw_rate  (0.18f, 0.018f, 0.000f, 0.5f, 0.0f, 0.0f, 5.0f)
